...
const AnimatedNavLink = ({ to, children }: { to: string; children: React.ReactNode }) => {
  ...
  return (
    <Link to={to} className={`group relative inline-flex items-center overflow-hidden h-7 ${textSizeClass}`}>
      <div className="flex flex-col transition-transform duration-400 ease-out transform group-hover:-translate-y-full leading-6">
